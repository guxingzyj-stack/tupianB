...
# 修复 prompt: 以"自然、忠实于原片"为第一优先 —— 实测过度加力会让模型擅自改衣服/背景
# 颜色、过饱和发假。这里只做"去损伤+提清晰+合理上色/还原", 并明确禁止改动既有颜色与构图。
_RESTORE_PROMPTS = {
    "修旧如新": "修复这张老照片：去除划痕、折痕和噪点，修正褪色和偏黄，适度提升清晰度，"
    "效果自然真实、像原本拍得很好的照片。严格保持原有色调、构图、衣物颜色与人物身份不变，"
    "不夸张、不新增或更改内容。",
    "变成彩色": "为这张黑白老照片自然真实地上色：肤色与环境色合理协调、贴近真实生活，"
    "色彩柔和不夸张、不过饱和；顺带去除划痕、适度提升清晰度。严格保持人物身份、表情、"
    "构图和明暗关系不变，不臆造或改变原有内容。",
    "颜色还原": "还原这张老照片褪去的真实色彩、去除偏黄，色彩自然不夸张；去划痕、"
    "适度提升清晰度。严格保持原有构图与人物身份不变，不臆造内容。",
    "脸更清楚": "修复并增强这张老照片中的人物面部，使五官清晰自然、肤质真实，"
    "神态保持原样；整体去划痕、适度提升清晰度。严格保持人物身份与五官特征不变，不新增内容。",
}
