...
_RESTORE_PROMPTS = {
    "修旧如新": "高质量专业修复这张老照片：彻底去除划痕、折痕、噪点与污渍，"
    "大幅提升清晰度与细节(五官、头发、衣物纹理清晰锐利)，修正褪色与偏黄，"
    "让画面通透明亮、层次分明、对比鲜明，肤色红润自然、富有生气，"
    "达到专业照片修复馆的水准。严格保持人物身份、表情与五官特征不变，"
    "不夸张、不新增或更改内容。",
    "变成彩色": "为这张黑白老照片进行专业级自然上色并修复：肤色红润真实、"
    "衣物与环境色彩丰富协调、画面鲜活通透明亮、层次分明；同时彻底去除"
    "划痕噪点、大幅提升清晰度与细节。严格保持人物身份与五官不变，"
    "色彩真实考究不夸张，不新增内容。",
    "颜色还原": "还原并增强这张老照片的真实色彩：去除偏黄与色偏，让色彩饱满"
    "自然、画面通透明亮、层次分明，彻底去划痕噪点、大幅提升清晰度与细节，"
    "肤色红润真实。严格保持人物身份不变，不夸张、不新增内容。",
    "脸更清楚": "专业修复并增强这张老照片中的人物面部：五官清晰锐利、肤质"
    "细腻真实、神态自然生动、眼睛明亮有神；整体彻底去划痕噪点、大幅提升"
    "清晰度与质感。严格保持人物身份与五官特征不变，不新增内容。",
}
